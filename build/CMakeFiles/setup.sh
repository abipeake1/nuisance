...
add_to_PATH "/root/software/nuisance/build/Linux/bin"

add_to_LD_LIBRARY_PATH "/root/software/nuisance/build/Linux/lib"

export NUISANCE="/root/software/nuisance/build/Linux"
